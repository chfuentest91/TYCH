...
# Credenciales de integración (pruebas) — del profesor
...
def crear_transaccion(buy_order, session_id, amount, return_url):
    """Paso 1: Crear transacción en Transbank. Retorna {'token': ..., 'url': ...}"""
    body = {
...
def confirmar_transaccion(token_ws):
    """Paso 2: Confirmar (commit) la transacción. Retorna detalle del pago."""
